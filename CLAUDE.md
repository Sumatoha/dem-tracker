...
### 7. Push-уведомления
- `NotificationManager.swift` для вечерних отчётов
- Разрешение запрашивается в ProfileView
- Настраиваемое время отправки (DatePicker)
- Уведомление содержит статистику за день
